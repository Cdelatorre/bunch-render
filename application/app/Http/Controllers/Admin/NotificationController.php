...
class NotificationController extends Controller
{
    ...
    public function globalUpdate(Request $request){
        ...
        $notify[] = ['success','Global notification settings has been updated successfully'];
        return back()->withNotify($notify);
    }

    public function templates(){
        $pageTitle = 'Notification Templates';
        $templates = NotificationTemplate::orderBy('name')->where('status', 1)->get();
    ...
    public function templateUpdate(Request $request,$id){
        ...
        $notify[] = ['success','Notification template has been updated successfully'];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'Email settings has been updated successfully'];
        return back()->withNotify($notify);
    }
   ...
   public  function smsSetting(){
    ...
    public function smsSettingUpdate(Request $request){
        ...
        $general->save();
        $notify[] = ['success', 'Sms settings has been updated successfully'];
        return back()->withNotify($notify);
    }
