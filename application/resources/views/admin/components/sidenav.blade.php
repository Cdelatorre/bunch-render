            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.category.*') }}">
                    <a href="{{ route('admin.category.index') }}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Activities')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.service.*') }}">
                    <a href="{{ route('admin.service.index') }}" class="nav-link ">
                        <i class="menu-icon las la-campground"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.product.*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Gyms')</span>
                    </a>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.users.*') }}">
                    <a href="{{ route('admin.users.active') }}" class="nav-link ">
                        ...
                        @if ($bannedUsersCount > 0 || $deletedUsersCount > 0 || $emailUnverifiedUsersCount > 0 || $mobileUnverifiedUsersCount > 0)
