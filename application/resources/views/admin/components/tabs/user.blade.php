<div class="row">
    <div class="col">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.users.deleted') ? 'active' : '' }}"
                    href="{{route('admin.users.deleted')}}">@lang('Deleted')
                    @if($deletedUsersCount)
                    <span class="badge rounded-pill bg--white text-muted">{{$deletedUsersCount}}</span>
                    @endif
                </a>
            </li>
            <li class="nav-item">
