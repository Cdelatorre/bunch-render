                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label class="required">@lang('Home Section')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <select name="homesection" class="form-control" id="homesection">
                                        <option {{$general->homesection == 1 ? 'selected' : '' }} value="1">@lang('Section One')</option>
                                        <option {{$general->homesection == 2 ? 'selected' : '' }} value="2">@lang('Section Two')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
