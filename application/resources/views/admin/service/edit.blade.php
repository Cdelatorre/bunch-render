                    ...
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                <button type="button" class="icon-btn updateBtn" data-id="{{ $service->id }}" data-name="{{ __($service->name) }}" data-parent="{{ $p_service->id }}" data-status="{{ $service->status }}" data-toggle="tooltip"  data-original-title="@lang('Edit')">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin.service.store') }}">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="parent" class="form-control d-none" value="{{ $p_service->id }}">
                    <div class="form-group">
    ...
    <script>
        (function ($) {
            ...
            $('.updateBtn').on( 'click', function () {
                ...
                modal.find('.modal-title').text("@lang('Update Service')");
                modal.find('[name=name]').val($(this).data('name'));
                modal.find('[name=parent]').val($(this).data('parent'));
