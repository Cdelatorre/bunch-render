...
Route::get('/clear', function(){
    ...
    $notify[] = ['success', 'All cache has been deleted.'];
...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        Route::get('fetch-logins', 'fetchLoginsData')->name('fetch.userLogins');
        Route::get('fetch-activities', 'fetchActivities')->name('fetch.userActivities');
        Route::get('fetch-prices', 'fetchPrices')->name('fetch.userPrices');
        Route::get('fetch-services', 'fetchServices')->name('fetch.userServices');
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('manage/users')->group(function(){
        ...
        Route::post('remove/{id}', 'removeUser')->name('remove');
    ...
    Route::controller('KycController')->name('kyc.')->prefix('kyc')->group(function(){
        Route::get('form-data', 'kycForm')->name('form');
        Route::post('form-data', 'kycFormSubmit')->name('form.submit');
    });


    Route::controller('CategoryController')->name('category.')->prefix('activities')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'categoryStore')->name('store');
    });

    Route::controller('ServiceController')->name('service.')->prefix('services')->group(function(){
        Route::get('/', 'index')->name('index');
        Route::get('/edit/{id?}', 'edit')->name('edit');
        Route::post('store/{id?}', 'serviceStore')->name('store');
    });

    Route::controller('ProductController')->name('product.')->prefix('gym')->group(function(){
        ...
        Route::post('approved/{id}', 'approve')->name('approve');
        ...
        Route::get('{id}/users', 'productUsers')->name('users.list');
        Route::post('user/winner', 'userWinner')->name('user.winner');
        Route::get('winners', 'winners')->name('winners');
        Route::post('winners', 'deliveredProduct')->name('product.delivered');
        Route::post('remove/{id}', 'removeProduct')->name('remove');
    });
    ...
    Route::controller('GeneralSettingController')->group(function(){
        ...
        Route::post('cookie','cookieSubmit');
         ...
         //socialite credentials----GeneralSettingController
